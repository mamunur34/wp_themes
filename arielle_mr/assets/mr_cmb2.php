...
function arielle_register_metabox() {
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Set Banner Image', 'cmb2' ),
	...
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Set Page Custom Header', 'cmb2' ),
		'desc' => esc_html__( 'Set Page Custom Header', 'cmb2' ),
		'id'   => $prefix . 'custom_header',
		'type' => 'text_medium',
	) );
    
	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Set header custom paragraph', 'cmb2' ),
		'desc' => esc_html__( 'Set header custom paragraph', 'cmb2' ),
		'id'   => $prefix . 'custom_header_para',
		'type' => 'text_medium',
	) );
